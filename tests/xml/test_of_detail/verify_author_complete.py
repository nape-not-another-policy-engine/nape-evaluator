def evaluate(evidence, evaluations, metadata):
    ...
    if status_fact["status"] != "found":
        return {
            ...
            "facts": [status_fact],
            "reason": "The XML evidence did not provide a usable status value.",
        }
...
def _evaluate_status(status_fact, expected_status):
    ...
    if actual_status == expected_status:
        return {
            "conclusion": "true",
            "facts": [status_fact],
            "reason": f"The XML status is {expected_status}.",
        }
    ...
    return {
        ...
        "facts": [status_fact],
        "reason": (
            f"The XML status is '{actual_status}', not '{expected_status}'."
        ),
    }
